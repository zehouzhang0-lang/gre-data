...
基础设施和 30 天主计划已经建立。当前目标为 Verbal + Quantitative 合计 325，计划从 2026-09-02 的 Day 1 执行到 2026-10-01 的 Day 30。个人档案仍需补充：
...
规范化计划在 `planning/30-day-plan.yaml`。它保留原图的四个阶段，并把范围固定成可验收日目标：30–40 题取 35，6–8 篇取 7；20–30 题取 25，6–7 篇取 6；模考 1–2 套取每天 1 套。
